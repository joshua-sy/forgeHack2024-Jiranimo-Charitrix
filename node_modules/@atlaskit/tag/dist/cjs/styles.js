...
var focusRingColors = exports.focusRingColors = "var(--ds-border-focused, ".concat(colors.B100, ")");
var borderRadius = exports.borderRadius = {
  default: _constants.defaultBorderRadius,
  rounded: _constants.defaultRoundedBorderRadius
};
var removalHoverBackgroundColors = exports.removalHoverBackgroundColors = "var(--ds-background-danger, ".concat(colors.R50, ")");
var removalActiveBackgroundColors = exports.removalActiveBackgroundColors = "var(--ds-background-danger-hovered, ".concat(colors.R50, ")");
var removalTextColors = exports.removalTextColors = "var(--ds-text-danger, ".concat(colors.R500, ")");
